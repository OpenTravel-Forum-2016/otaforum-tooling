...
/**
 * Updates the details of an API.
 * 
 * @author S. Livezey
 */
public class UpdateAPIOperation extends RESTClientOperation<APIDetails> {
	 ...
	 */
	public UpdateAPIOperation(APIOperationFactory factory) {
		super(factory);
	}
